...
public class MessageController {
	...
	public String showMessageList(@RequestParam(required = false) String keyword,
		...
		List<ConversationPreview> conversations = messageService.getConversationPreviews(currentUser, keyword,
				chatType);
	...
	public String startPrivateChat(@RequestParam Long recipientId, @RequestParam String content,
			Authentication authentication) {
	...
	public String createGroupChat(@RequestParam String groupName, @RequestParam List<Long> memberIds,
			Authentication authentication) {
